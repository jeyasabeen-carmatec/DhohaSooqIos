...
//    _BTN_save.frame = frameset;
    ...
    if ([_LBL_item_name respondsToSelector:@selector(setAttributedText:)]) {
        ...
        // Define general attributes for the entire text0
...
/* product-reviews/add-review/"+product_id+"/"+userid+"/1
  params.put("comment", user_comment);
   params.put("rating", user_rating);
 */
#pragma mark saving product reviews
-(void)saving_product_reviews{
...
//        NSString *languge = [NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"language_id"]];
        ...
        NSString *urlGetuser =[NSString stringWithFormat:@"%@product-reviews/add-review/102/%@",SERVER_URL,user_id];
